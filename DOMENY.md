...
| `kadernictvi.dweby.cz` | `kadernictvi/studio-elegance` | `dist/sites/kadernictvi` |
...
| `kadernictvi.dweby.cz` | `studio-elegance` | `1` |
| `test.kadernictvi.dweby.cz` | `testovani/studio-elegance` | `1` (test) |
