/**
 * Admin účet domca.basek2@gmail.com — Studio Elegance (kadernictvi_id 1).
 *   node scripts/seed-domca-admin.mjs
 */
...
const EMAIL = "domca.basek2@gmail.com";
const PASSWORD = env.SEED_DOMCA_PASSWORD || "DomcaShowcase26!";
